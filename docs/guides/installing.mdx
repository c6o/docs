...
<TabItem value="macos" label="macOS" default>
   ...
   | Arch Type | URL                                                             |
   | --------- | --------------------------------------------------------------- |
   | amd64     | https://releases.codezero.io/2.5.2/headless-darwin-amd64.tar.gz |
   | arm64     | https://releases.codezero.io/2.5.2/headless-darwin-arm64.tar.gz |
...
<TabItem value="linux" label="Linux">
   ...
   | Arch Type | URL                                                             |
   | --------- | --------------------------------------------------------------- |
   | amd64     | https://releases.codezero.io/2.5.2/headless-linux-amd64.tar.gz  |
   | arm64     | https://releases.codezero.io/2.5.2/headless-linux-arm64.tar.gz  |
...
<TabItem value="windows" label="Windows">
   ...
   | Arch Type | URL                                                           |
   | --------- | ------------------------------------------------------------- |
   | amd64     | https://releases.codezero.io/2.5.2/headless-windows-amd64.zip |
   | arm64     | https://releases.codezero.io/2.5.2/headless-windows-arm64.zip |
