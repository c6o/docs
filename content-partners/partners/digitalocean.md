...
However, you may ask what about your code running in the cluster reaching our to your local code to troubleshoot that side of things? CodeZero's intercept feature forwards these calls in your cluster and can route these calls back to your local machine in a running or debugging session. This can be done selectively, based on the request's header key/value pair, because CodeZero allows your remote cluster software to continue as normal for everything except your desired interceptions. And, your colleagues can be intercepting the remote cluster at the same time without affecting you.
